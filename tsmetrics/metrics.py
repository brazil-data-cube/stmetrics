...
def get_metrics(series,show=False):
	...
	mean, maximum, minimum, std, sum, amplitude, first slope, area, area 1st quarter,
	area of 2nd quarter,area of 3th quarter, area of 4th quarter, circle, gyration, 
	polar balance e a angle.
	"""
